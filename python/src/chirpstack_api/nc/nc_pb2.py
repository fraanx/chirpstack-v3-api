...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\024io.chirpstack.api.ncB\026NetworkControllerProtoP\001Z*github.com/fraanx/chirpstack-v3-api/go/v3/nc'
