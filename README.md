...
![Tests](https://github.com/fraanx/chirpstack-v3-api/actions/workflows/main.yml/badge.svg?branch=master)
...
Documentation: https://godoc.org/github.com/fraanx/chirpstack-v3-api/go

```bash
go get github.com/fraanx/chirpstack-v3-api/go/v3
```
...
See the README in /java subfolder: https://github.com/fraanx/chirpstack-v3-api/tree/master/java.
